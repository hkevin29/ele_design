...
class GazeTracking(object):
    ...
    def annotated_frame(self):
        ...
        if self.eye_left:
            ...
            cv2.line(frame, (self.eye_left.origin[0], int((self.eye_left.origin[1] + self.eye_left.end[1]) / 2)),
                     (self.eye_left.end[0], int((self.eye_left.origin[1] + self.eye_left.end[1]) / 2)), (0, 0, 255))
        if self.eye_right:
            ...
            cv2.line(frame, (self.eye_right.origin[0], int((self.eye_right.origin[1] + self.eye_right.end[1]) / 2)),
                     (self.eye_right.end[0], int((self.eye_right.origin[1] + self.eye_right.end[1]) / 2)), (0, 0, 255))
